<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="exampleModal1" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered m-5" role="document">
        <div class="card-group">
            <div class="card">
                <img class="card-img-top" height="180px" src="Imagenes/conocidelpuesto.png">
                    <div class="card-body">
            ...
            <div class="card">
                <img class="card-img-top" height="180px" src="Imagenes/coaching-ejecutivo.jpg">
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            Trabajo en Equipo
                        </h5>
            ...
            <div class="card">
                <img class="card-img-top" height="180px" src="Imagenes/comunicaci.jpg">
                    <div class="card-body">
                        <h5 class="card-title text-center">
            ...
            <div class="card">
                <img class="card-img-top" height="180px" src="Imagenes/produccion.jpg">
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            Productividad
                        </h5>
